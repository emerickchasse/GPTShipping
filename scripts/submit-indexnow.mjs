...
const urls = [site, new URL('care-guide.html', site), new URL('transparency.html', site), new URL('bandana-size-guide.html', site), new URL('measure-pet-for-bandana.html', site), new URL('how-to-tie-dog-bandana.html', site)];
