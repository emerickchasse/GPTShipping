...
4ad. A size label is not a size guide. If the supplier API exposes S/M/L but no finished measurements, publish the verified fit warning and keep size selection closed until exact measurements are sourced and checked.
