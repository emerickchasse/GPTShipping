...
- `LIVE_CHECKOUT_ENABLED`, automatic tax, tax approval, merchant-account approval, sample approval, and supplier billing approval remain false. Customer-policy and private-support approvals are true after their provider-backed drills. Live revenue still cannot be queried with test credentials.
